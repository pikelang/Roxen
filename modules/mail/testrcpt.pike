/*
 * $Id: testrcpt.pike,v 1.8 1998/09/13 14:49:49 grubba Exp $
 *
...
constant cvs_version = "$Id: testrcpt.pike,v 1.8 1998/09/13 14:49:49 grubba Exp $";
...
{
  roxen_perror("RCPT: put(%O, %O, %O, %O, %O, X)\n",
