...
/*
 * $Id: prot_snmp.pike,v 2.6 2010/05/26 11:44:37 noring Exp $
 *
...
class RoxenGlobalMIB
{
  ...
  static array(int) update_rusage()
  {
  ...
  static void create()
  {
    ::create(SNMP.RIS_OID_WEBSERVER + ({ 1 }), ({}),
		 ...
		 UNDEFINED,
		 SNMP.Counter(lambda()
			      { return update_rusage()[0]/10; }, "userTime",
		   "User time expressed in centiseconds."),
		 SNMP.Counter(lambda()
			      { return update_rusage()[1]/10; }, "sysTime",
