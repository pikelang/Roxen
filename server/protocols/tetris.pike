...
1;}void tetris2(string name){sscanf(name,"%[a-zA-Z0-9едц≈ƒ÷ь№]s\n",name);if(!
...
0.5;io=input;input->get_name(tetris2);}class telnet{inherit Stdio.File;mixed д
;void do_get_name(mixed id, string name){д(name);}string get_name(mixed w){д=w
