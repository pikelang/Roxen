...
BOOL CCmdLine::Parse(int argc, char *argv[])
{
  ...
  while (i < argc)
  {
    ...
    case eArgSelfTest:
      ...
      system("xcopy etc\\roxen_test\\test_config ..\\var\\test_config\\ /E /Q /Y >NUL:");
      system("copy /Y etc\\roxen_test\\filesystem\\test_rxml_package rxml_packages\\test_rxml_package >NUL:");
