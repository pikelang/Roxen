...
constant cvs_version = "$Id: configuration.pike,v 1.578 2005/11/26 15:01:55 _cvs_dirix Exp $";
#include <module.h>
...
//! `no_magic' is set to one, the internal magic images and the
