/*
 * $Id: debug_summary.pike,v 1.12 2005/04/14 23:06:57 _cvs_dirix Exp $
 */
#include <stat.h>
...
#ifdef __NT__
  res += indent(Stdio.read_file("/usr/chilimoon/local/environment.ini")||"", 1);
#else
  res += indent(Stdio.read_file("/usr/chilimoon/local/environment")||"", 1);
#endif
