...
constant cvs_version="$Id: prototypes.pike,v 1.192 2009/06/10 12:55:30 mast Exp $";
...
//! sequence</ref>.
{
  ...
  // Internal but not protected. These have double use: At the start
  // of the timed period they are set to the starting point in time,
  // at the end they are changed to the elapsed time.
  int queue_time, handle_time;
