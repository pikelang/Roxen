...
constant cvs_version = "$Id: configuration.pike,v 1.599 2006/11/07 08:38:09 wellhard Exp $";
#include <module.h>
...
<table border='0' cellspacing='0' cellpadding='0' height='99%'>
  ...
  <tr>
    ...
    <td></td>
	 ...
	 DLOCALE(1002, "Authentication failed message"),
	 TYPE_TEXT_FIELD|VAR_PUBLIC,
	 DLOCALE(1003, "What to return when an authentication attempt failed."));
