...
constant cvs_version="$Id: roxen.pike,v 1.884 2004/11/16 18:59:52 jonasw Exp $";
...
// with 2.4.
array(string) compat_levels = ({"2.1", "2.2", "2.4", "2.5", "3.3", "3.4", "4.0"});
...
#define CROP   8
	...
	if( sizeof( args->maxwidth || args->maxheight ||
