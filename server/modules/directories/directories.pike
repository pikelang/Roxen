...
constant cvs_version = "$Id: directories.pike,v 1.106 2004/07/01 07:41:40 _cvs_dirix Exp $";
...
<html>
  ...
  <body bgcolor='black' text='black' link='#bf2727' vlink='#bf2727'>
    ...
    <font size='+3'>
   <emit source='path'>
     <a href='&server.path;&_.path:http;'> &_.name; <font color='#808080'>/</font></a>
   </emit> </font><br /><br />
...
{
  defvar("indexfiles",
         ({ "index.xml", "index.html", "index.pike","index.rxml" }),
