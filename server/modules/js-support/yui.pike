...
LocaleString module_name = LOCALE(0,"JavaScript Support: The YUI library");
LocaleString module_doc =
LOCALE(0,"This mounts the Yahoo! User Interface Library (YUI) as a virtual file system "
	 "in your site.");
