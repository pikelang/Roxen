...
constant cvs_version = "$Id: webapp.pike,v 2.18 2002/06/24 12:06:16 nilsson Exp $";
...
void create()
{
  ...
  defvar("tagtarget", "", "Target name", TYPE_STRING|VAR_MORE,
	 ("Target name to use in the servlet tag to reference "
