/*
 * $Id: ChiliMoonResponse.java,v 1.1 2004/05/31 11:48:51 _cvs_dirix Exp $
 *
 */
...
public abstract class ChiliMoonResponse {
  ...
  ChiliMoonResponse(int _errno, String _type, long _len)
  {
    errno = _errno;
    type = _type;
    len = _len;
