/*
 * $Id: ChiliMoonConfiguration.java,v 1.1 2004/05/31 11:48:51 _cvs_dirix Exp $
 *
 */
 ...
 * the ChiliMoon server.
 *
 * @version	$Version$
 * @author	marcus
 */

public class ChiliMoonConfiguration {
  /**
   * Get the real path of a virtual file
   *
   * @param name The virtual file name
   */
  public native String getRealPath(String filename, ChiliMoonRequest id);
   ...
   */
  public native String getFileContents(String filename, ChiliMoonRequest id);
