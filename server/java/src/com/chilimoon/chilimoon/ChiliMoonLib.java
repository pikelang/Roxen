/*
 * $Id: ChiliMoonLib.java,v 1.1 2004/05/31 11:48:51 _cvs_dirix Exp $
 *
 */
...
public class ChiliMoonLib extends HTTP {
  ...
  public native static String doOutputTag(Map args, Map[] varArr,
					  String contents, ChiliMoonRequest id);
   ...
   */
  public native static String parseRXML(String what, ChiliMoonRequest id);
